"""Scraper for The Edge Singapore — News section."""
...
LISTING_URL = "https://www.theedgesingapore.com/section/news"
RSS_URLS = [
    "https://www.theedgesingapore.com/rss.xml",
    "https://www.theedgesingapore.com/feed",
    "https://www.theedgesingapore.com/rss",
]
CUTOFF_HOURS = 8


class TheEdgeSingaporeScraper(BaseScraper):
    ...
    def scrape(self) -> list[Article]:
        for rss_url in RSS_URLS:
            ...
            if articles:
                return articles
        logger.warning("The Edge Singapore RSS failed; falling back to HTML")
    ...
    def _scrape_rss(self, rss_url: str) -> list[Article]:
        try:
            ...
            logger.warning("The Edge Singapore RSS (%s) failed: %s", rss_url, exc)
            return []
    ...
    def _scrape_html(self) -> list[Article]:
        ...
        try:
            ...
            for item in items:
                ...
                time_el = item.select_one("time[datetime], [class*='date'], [class*='published']")
                ...
                if not url.startswith("http"):
                    url = "https://www.theedgesingapore.com" + url
            ...
            logger.warning("The Edge Singapore HTML scrape failed: %s", exc)
